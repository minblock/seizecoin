# Support for Output Descriptors in Seizecoin Core

Since Seizecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Seizecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Seizecoin Core wallets, a convenience function `combo` is
