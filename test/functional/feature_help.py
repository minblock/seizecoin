...
"""Verify that starting seizecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start seizecoin with -h for help text")
        ...
        self.log.info("Start seizecoin with -version for version information")
        ...
        self.log.info("Start seizecoind with -fakearg to make sure it does not start")
