...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " seizecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  seizecoin-tx [options] <hex-tx> [commands]  Update hex-encoded seizecoin transaction\n" +
            "or:     seizecoin-tx [options] -create [commands]   Create hex-encoded seizecoin transaction\n" +
            "\n";
