...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586332632, 627062, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x15f823a9b2be5a04b29d4bb40a053b523e6092365c8c126efb4879fbd04ad7d5"));
        ...
        vSeeds.emplace_back("seed-a.seizecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.seizecointools.com");
        vSeeds.emplace_back("dnsseed.seizecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.seizecointools.com");
        vSeeds.emplace_back("seed-b.seizecoin.loshan.co.uk");
