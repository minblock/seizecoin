...
pkgdatadir = $(datadir)/seizecoin
pkgincludedir = $(includedir)/seizecoin
pkglibdir = $(libdir)/seizecoin
pkglibexecdir = $(libexecdir)/seizecoin
...
ACLOCAL = ${SHELL} /seizecoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /seizecoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /seizecoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /seizecoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = seizecoin-cli
BITCOIN_DAEMON_NAME = seizecoind
BITCOIN_GUI_NAME = seizecoin-qt
BITCOIN_TX_NAME = seizecoin-tx
BITCOIN_WALLET_TOOL_NAME = seizecoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Seizecoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Seizecoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /seizecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = seizecoin
PACKAGE_BUGREPORT = https://github.com/seizecoin-project/seizecoin/issues
PACKAGE_NAME = Seizecoin Core
PACKAGE_STRING = Seizecoin Core 0.18.1
PACKAGE_TARNAME = seizecoin
PACKAGE_URL = https://seizecoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /seizecoin
abs_srcdir = /seizecoin
abs_top_builddir = /seizecoin
abs_top_srcdir = /seizecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /seizecoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Seizecoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Seizecoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Seizecoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Seizecoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
